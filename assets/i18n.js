...
;(function (global) {
  ...
  const FR = {
    ...
    'd.cop.ask':            'Demander',
    'd.cop.s1':             "Pourquoi l'attrition augmente-t-elle ?",
    'd.cop.s2':             "Où le risque d'épuisement est-il le plus élevé ?",
    'd.cop.s3':             'Prévoir la rétention pour le prochain trimestre',
    'd.cop.s4':             'Rédiger le résumé pour le conseil',
    'd.cop.clear':          'Effacer la conversation',
    'd.cop.insightQ':       'En savoir plus sur',
    ...
    'bf.stabSub.6m':        '6 derniers mois',
    'bf.stabSub.1a':        '12 derniers mois',
